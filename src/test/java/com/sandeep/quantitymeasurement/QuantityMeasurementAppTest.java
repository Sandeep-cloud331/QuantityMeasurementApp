...
import com.sandeep.quantitymeasurement.model.QuantityDTO;
import com.sandeep.quantitymeasurement.model.QuantityInputDTO;
import com.sandeep.quantitymeasurement.model.QuantityMeasurementDTO;
import com.sandeep.quantitymeasurement.repository.QuantityMeasurementRepository;
...
//
//        assertEquals(HttpStatus.OK, r.getStatusCode());
//        assertEquals(2, r.getBody().contains("2"));
//    }
...
//
//        ResponseEntity<String> r = restTemplate.getForEntity(
//        	    base + "/history/errored", String.class);
//
//        	assertEquals(HttpStatus.OK, r.getStatusCode());
//        	assertTrue(r.getBody().contains("error"));
//    }
